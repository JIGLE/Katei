...
const TABLES = ['assignments', 'activity', 'notifications', 'push_subscriptions', 'savings_entries', 'savings_goals', 'invites', 'household_events', 'money_streams', 'users', 'app_settings'];
